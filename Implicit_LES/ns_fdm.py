...
#    r[1:n,1] = ((-3.0-2.0*p)*u[0:n-1,1] + 4.0*p*u[1:n,1] + (3.0-2.0*p)*u[2:n+1,1])/h
    r[0,1] = ((-3.0-2.0*p)*u[n-1] + 4.0*p*u[0] + (3.0-2.0*p)*u[1])/h  
