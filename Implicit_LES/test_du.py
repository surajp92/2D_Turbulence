...
def rhs_cu3dp(nx,dx,a,u,pCU3):
   
    up = cu3dp(u,pCU3,dx,nx)
    r = -a*up
    
    return r

def rhs_c4dp(nx,dx,a,u):
...
#%%
scheme = 4 # [1] FT Upwind [2] RK4 C4 [3] RK4 CU3P [4] RK4 C4DP
x0 = 0.0
xL = 1.0
nx = 40
tmax = 1.0
...
for k in range(1,int(nt)+1):
    if scheme == 1:
        ...
        r1 = rhs_cu3dp(nx,dx,a,u,pCU3)
        k1 = dt*r1
        
        r2 = rhs_cu3dp(nx,dx,a,u+0.5*k1,pCU3)
        k2 = dt*r2
        
        r3 = rhs_cu3dp(nx,dx,a,u+0.5*k2,pCU3)
        k3 = dt*r3
        
        r4 = rhs_cu3dp(nx,dx,a,u+k3,pCU3)
        k4 = dt*r4
        
        u = u + (k1 + 2.0*(k2 + k3) + k4)/6.0
    
    elif scheme == 4:        
        r1 = rhs_c4dp(nx,dx,a,u)
        k1 = dt*r1
        
        r2 = rhs_c4dp(nx,dx,a,u+0.5*k1)
        k2 = dt*r2
        
        r3 = rhs_c4dp(nx,dx,a,u+0.5*k2)
        k3 = dt*r3
        
        r4 = rhs_c4dp(nx,dx,a,u+k3)
        k4 = dt*r4
