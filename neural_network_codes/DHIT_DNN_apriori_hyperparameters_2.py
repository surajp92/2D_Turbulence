...
def build_dnn_model(n_layers=2, n_neurons=60, lr=0.001, n_features=10, n_labels=3):
    model = Sequential()
...
n_layers = [2]#,3,5,7]
n_neurons = [40]#,30,20,50]
lr_params = [0.0001]#, 0.001]
...
np.savetxt('hP_trial.csv',hp_results,delimiter=",")
