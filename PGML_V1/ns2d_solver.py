...
if ifm == 0:
    ...
    model = load_model('./nn_history/CNN_model_'+str(ifeat)+'_S.hd5',custom_objects={'coeff_determination': coeff_determination})
    max_min = np.load('./nn_history/scaling_cnn_S.npy')
elif ifm == 3:
    if ifeat == 2:
        model = load_model('./nn_history/DNN_model_2_'+str(ifeat)+'.hd5',custom_objects={'coeff_determination': coeff_determination})
    elif ifeat == 3:
        model = load_model('./nn_history/DNN_model_1_'+str(ifeat)+'.hd5',custom_objects={'coeff_determination': coeff_determination})
    max_min = np.load('./nn_history/scaling_dnn.npy')
